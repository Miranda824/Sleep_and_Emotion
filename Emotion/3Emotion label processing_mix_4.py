...
def process_Z(y_arousal, y_valence, idx_arousalmin1, idx_arousalmax1, idx_valencemin1, idx_valencemax1,
              ...
              idx_arousalmin4, idx_arousalmax4, idx_valencemin4, idx_valencemax4):
    ...
    any_condition = np.any(np.logical_or(condition_arousal1, condition_valence1)) or np.any(np.logical_or(condition_arousal2, condition_valence2)) or np.any(np.logical_or(condition_arousal3, condition_valence3)) or np.any(np.logical_or(condition_arousal4, condition_valence4))
...
pre_Z = process_Z(Y[:, [0]], Y[:, [1]], 1, 3, 7, 9,
                                        1, 3, 3, 5,
                                        3, 5, 1, 5,
                                        7, 9, 3, 5)
...
pre_L = process_L(N[:, [0]], N[:, [1]], 1, 3, 7, 9,
                                        1, 3, 3, 5,
                                        3, 5, 1, 5,
                                        7, 9, 3, 5)
...
print(V.shape)
pre_V = process_L(V[:, [0]], V[:, [1]], 1, 3, 7, 9,
                                        1, 3, 3, 5,
                                        3, 5, 1, 5,
                                        7, 9, 3, 5)
